...
import (
	...
	"github.com/sommitfreshket/pdfcpu/internal/corefont/metrics"
...
func (fd TTFLight) unicodeRangeBits(id string) []int {
	...
	// Please go to https://github.com/sommitfreshket/pdfcpu/issues/new/choose for an extension request.
	//
