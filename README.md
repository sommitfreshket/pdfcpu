...
[![Test](https://github.com/sommitfreshket/pdfcpu/workflows/Test/badge.svg)](https://github.com/sommitfreshket/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/sommitfreshket/pdfcpu?status.svg)](https://pkg.go.dev/github.com/sommitfreshket/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/sommitfreshket/pdfcpu)](https://goreportcard.com/report/github.com/sommitfreshket/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/sommitfreshket/pdfcpu/releases)
...
* For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/sommitfreshket/pdfcpu/pkg/api).

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/sommitfreshket/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/sommitfreshket/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/sommitfreshket/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/sommitfreshket/pdfcpu/releases).


### Using Go Modules

```
$ git clone https://github.com/sommitfreshket/pdfcpu
...
```
$ go install github.com/sommitfreshket/pdfcpu/cmd/pdfcpu@latest
```
...
* Please [create](https://github.com/sommitfreshket/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
* Feature requests - always welcome!
* Bug fixes - always welcome!
* PRs - let's [discuss](https://github.com/sommitfreshket/pdfcpu/discussions) first or [create](https://github.com/sommitfreshket/pdfcpu/issues/new/choose) an issue.
* pdfcpu is stable but still *Alpha* and occasionally undergoing heavy changes.

### How

* The pdfcpu [discussion board](https://github.com/sommitfreshket/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
